...
public abstract class Weapon {
    ...
    /**
     * Returns a new independent copy of this weapon with cooldown timers reset to 0.
     * Used by WeaponPool so each equipped instance has its own timer state.
     */
    public abstract Weapon clonar();
}
